...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    startBtn.addEventListener("click", async () => {
        try {
            ...
            found = eventsFoundResponse.found
            eventsFoundElement.innerHTML = `${found} events found`
            duplicates = eventsFoundResponse.duplicatesFound
            duplicateEvents.innerHTML = `${duplicates} are spotted as duplicates and may result in not being imported. This can lead to a "${found - duplicates} of ${found} imported" message`
